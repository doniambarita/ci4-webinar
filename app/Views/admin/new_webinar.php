...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Create a new webinar</h1>

    <div class="row">
        <div class="col-lg-12">
            <div class="swal-new_webinar" data-swal="<?= session()->getFlashdata('message'); ?>"></div>
            <form action="<?= base_url('admin/new-webinar'); ?>" method="post" enctype="multipart/form-data"
                autocomplete="off">
                <?= csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <textarea
                            ...
                            minlength="90" required value=""><?= old('description') ?></textarea>
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <input type="text"
                            ...
                            id="speaker" name="speaker" minlength="2" maxlength="70" value="<?= old('speaker') ?>"
                            required>
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-8">
                        <input type="date"
                            ...
                            name="date" value="<?= old('date') ?>" min="<?= date('Y-m-d', strtotime("+1 days")); ?>"
                            required>
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <img src="<?= base_url('img/'); ?>" alt="webinar cover" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-6">
